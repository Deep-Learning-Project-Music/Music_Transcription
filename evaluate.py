...
def evaluate_file(model_file, dataset, dataset_group, sequence_length, save_path,
                  onset_threshold, frame_threshold, device, name, label_shift=0):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='current', type=str)
    ...
    result_df.to_csv(f'{path}/{run_name}.csv', sep=',', na_rep='NaN')
