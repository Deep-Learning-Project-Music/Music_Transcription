...
if __name__ == '__main__':
    ...
    parser.add_argument('model_file', type=str, default='runs/transcriber-231117-105545/model-best-notef1.pt')
    ...
    # print(wandb_path)
    run_date = 'wandb/run-20231129_124344-0291ezz7' #'20' + str(args.model_file).split('-')[1]
    ...
    for wandb_run in wandb_path:            
        if run_date in str(wandb_run):
            ...
            if len(config) >= 20 and f'{run}/model/{logdir}' == config['logdir']['value']:
    ...
    result_df.to_csv(f'/home/ubuntu/low-latency-amt/onsets_and_frames/{run_name}.csv', sep=',', na_rep='NaN')
